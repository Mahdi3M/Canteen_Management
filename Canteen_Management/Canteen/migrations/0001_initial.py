# Generated by Django 4.2.5 on 2023-10-16 12:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personal_no', models.CharField(blank=True, max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Admin', 'Admin'), ('Bar NCO', 'Bar NCO'), ('Customer', 'Customer')], default='Customer', max_length=10)),
                ('image', models.ImageField(blank=True, default='..\\static\\assets\\img\\default_user.jpg', null=True, upload_to='profile_pics')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Canteen.order')),
            ],
        ),
    ]
